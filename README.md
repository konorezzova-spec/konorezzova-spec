...
- [Pure Moment](https://github.com/konorezzova-spec/project-Pure-Moment) – Team project. A single-page website for a wedding photographer featuring categorized photo galleries, wishlist functionality, and a contact form. Role: Team Lead / Front-End Developer. Tech stack: HTML, CSS, JavaScript, Git, REST API, Vite.
  [Live Demo](https://konorezzova-spec.github.io/project-Pure-Moment/)
- [Organic Shop](https://konorezzova-spec.github.io/project-zaika-shop/) – A one-page website for a health food store, created using HTML, CSS and JavaScript. Tech stack: HTML, CSS, JavaScript.
  [Live Demo](https://konorezzova-spec.github.io/project-zaika-shop/)
...
<!--
**konorezzova-spec/konorezzova-spec** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
