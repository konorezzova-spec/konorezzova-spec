...
💻Featured Projects  
- [NoteHub](https://github.com/konorezzova-spec/09-auth) – A privet notes management system with secure server-side authentication and real-time state synchronization. Tech stack: Next.js, React, TypeScript, HTML, CSS, Git, REST API
